...
void ClapTrap::printParam() {
	print(this->name);
	print(this->hitPoints);
	print(this->maxHitPoints);
	print(this->energyPoints);
	print(this->maxEnergyPoints);
	print(this->level);
	print(this->meleeAttackDamage);
	print(this->rangeAttackDamage);
	print(this->armorDamageReduction);
}
